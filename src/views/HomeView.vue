<template>
  ...
  <body>
    <main class="p-1 bg-black">
      ...
      <!-- Cards -->
      <div class="flex flex-col justify-center sm:flex-wrap md:flex-row sm:justify-between mt-6 sm:p-10">
        ...
        <div class="flex justify-center overflow-hidden max-h-fit max-w-md w:64 sm:max-w-xs sm:w-64 mb-1">
          <div class="shadow-lg bg-white">
            <div class="max-h-fit">
              <a href="#!">
                <img class="w-full" src="https://mdbootstrap.com/img/new/standard/nature/184.jpg" alt="" />
              </a>
            </div>
            <div class="p-0 flex justify-center">
              <h5 class="text-gray-900 text-xl font-medium mb-2">PC</h5>
